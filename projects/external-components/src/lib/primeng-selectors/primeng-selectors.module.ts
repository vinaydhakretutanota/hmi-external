import { AbcggjComponent } from './components/abcggj-external/abcggj-external.component';
...
@NgModule({
    declarations: [PasswordExternalComponent,
        ...
        FileUploadComponent,
        TypeaheadComponent,
        NavMenuComponent, AbcggjComponent],
    ...
    exports: [PasswordExternalComponent,
        ...
        TypeaheadComponent, NavMenuComponent, AbcggjComponent],
    providers: [
        DialogService,
        providePrimeNG({ 
            theme: {
